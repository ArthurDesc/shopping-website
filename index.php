...
<main class="flex-grow mb-8">
    ...
    <div id="warning-modal" class="modal-overlay show fixed inset-0 bg-black bg-opacity-50 z-[9999] flex items-center justify-center">
        <div class="bg-white rounded-lg p-8 max-w-md mx-4 text-center">
            ...
            <h2 class="text-2xl font-bold mb-4 text-gray-800">⚠️ Site de démonstration</h2>
            <p class="text-gray-600 mb-6">
                Ce site est un exercice de développement web et n'est pas une véritable boutique en ligne. 
                Aucune transaction réelle ne sera effectuée et les produits ne sont pas disponibles à l'achat.
            </p>
            <button onclick="acceptWarning()" class="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                J'ai compris
            </button>
        </div>
    </div>
...
<script>
    function acceptWarning() {
        // Enregistrer l'acceptation dans une session
        fetch('<?= url("ajax/accept_warning.php") ?>')
    ...
    // Empêcher la fermeture de la modale en cliquant en dehors
