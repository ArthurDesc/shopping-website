<footer class="bg-gradient-to-b from-blue-400 to-blue-600 text-white py-6 px-4 mt-36 font-sans loading">  <div class="container mx-auto max-w-6xl md:px-4 lg:px-8">
