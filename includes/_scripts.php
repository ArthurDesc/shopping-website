...
<?php if (basename($_SERVER['PHP_SELF']) === 'produit.php'): ?>
  ...
  <script src="<?php echo url('assets/js/dropdown.js'); ?>"></script>
  <script src="<?php echo url('assets/js/productFilter.js'); ?>"></script>
  <script src="<?php echo url('assets/js/detail.js'); ?>" defer></script>
...
<?php if (basename($_SERVER['PHP_SELF']) === 'profil.php'): ?>
  <script src="<?php echo url('assets/js/profil.js'); ?>"></script>
