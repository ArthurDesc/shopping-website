...
document.addEventListener('DOMContentLoaded', function() {
    ...
    telephoneInput.addEventListener('keypress', function(e) {
        if (e.key !== 'Backspace' && e.key !== 'Delete' && e.key !== 'ArrowLeft' && e.key !== 'ArrowRight') {
            ...
            // Empêcher la saisie si déjà 10 chiffres
    ...
    // Nettoyer le numéro lors de la perte de focus
    telephoneInput.addEventListener('blur', function() {
        const numeroNettoye = this.value.replace(/\D/g, '');
        if (numeroNettoye.length > 0 && numeroNettoye.length !== 10) {
