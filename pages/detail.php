                            ...
                            <?php if (!empty($avis_produit)): ?>
                                <?php foreach (array_slice($avis_produit, 0, 5) as $avis): ?> <!-- Limiter l'affichage à 5 avis -->
                                    <div class="mb-6 p-6 border rounded-xl shadow-lg bg-white" data-avis-id="<?php echo $avis->getIdAvis(); ?>">
                                        <!-- Conteneur principal avec flex et justify-between -->
                                        <div class="flex justify-between items-start mb-2">
                                            <!-- Partie gauche avec le nom et les étoiles -->
                                            ...
                                            <!-- Partie droite avec la date et les icônes -->
                                        ...
                                        <p class="text-gray-700 mt-4"><?php echo htmlspecialchars($avis->getCommentaire()); ?></p>
                                    </div>
                                <?php endforeach; ?>
                                ...
                                <form id="comment-form" class="space-y-4">
                                    ...
                                    <div>
                                        <div class="flex flex-col gap-4">
                                            ...
                                            <!-- Conteneur pour les étoiles et le bouton -->
                                            <!-- Conteneur pour les étoiles et le bouton -->
                                                    ...
                                                    <div class="star-wrapper">
                                                        <?php for ($i = 1; $i <= 5; $i++): ?>
                                                            ...
                                                            <label for="star<?php echo $i; ?>" class="cursor-pointer">
                                                                <i class="fas fa-star s<?php echo $i; ?>"></i>
                                                            </label>
                                                        <?php endfor; ?>
                                                    </div>
                                                </div>
                                            ...
                                            <button class="avis-button w-1/2">
