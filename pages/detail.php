                                ...
                                <form id="comment-form" class="space-y-4">
                                    ...
                                    <div>
                                        <div class="flex gap-4">
                                            <!-- Zone de commentaire (3/4 de la largeur) -->
                                            <div class="w-3/4">
                                            ...
                                            <!-- Conteneur pour les étoiles et le bouton (1/4 de la largeur) -->
                                            <div class="w-1/4">
    <div class="h-24 flex flex-col justify-end gap-3">
        <!-- Note (étoiles) -->
        <div class="flex items-center gap-2">
        ...
        <button class="avis-button w-full">
